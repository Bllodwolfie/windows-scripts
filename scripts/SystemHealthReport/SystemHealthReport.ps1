...
[void]$html.AppendLine('')
[void]$html.AppendLine('.header { display: flex; align-items: center; padding: 12px 20px; margin-bottom: 28px; background: color-mix(in srgb, var(--mantle) 80%, transparent); backdrop-filter: blur(8px); border-radius: 12px; position: sticky; top: 0; gap: 12px; z-index: 100; }')
...
[void]$html.AppendLine('    color: var(--text); font-size: 20px; cursor: pointer;')
...
[void]$html.AppendLine('    transition: background 0.3s, transform 0.2s;')
[void]$html.AppendLine('    box-shadow: 0 2px 8px rgba(0,0,0,0.15);')
[void]$html.AppendLine('}')
[void]$html.AppendLine('.theme-toggle:hover { transform: scale(1.1); }')
[void]$html.AppendLine('')
...
[void]$html.AppendLine('    padding: 0 0 24px;')
...
[void]$html.AppendLine('.sidebar h3 {')
[void]$html.AppendLine('    position: sticky; top: 0; z-index: 1;')
[void]$html.AppendLine('    padding: 16px 16px 8px; margin: 0;')
...
[void]$html.AppendLine('}')
[void]$html.AppendLine('.sidebar-toggle {')
[void]$html.AppendLine('    width: 40px; height: 40px; border-radius: 50%;')
[void]$html.AppendLine('    background: var(--toolbar-bg); border: 2px solid var(--surface0);')
[void]$html.AppendLine('    color: var(--text); font-size: 18px; cursor: pointer;')
[void]$html.AppendLine('    box-sizing: border-box;')
[void]$html.AppendLine('    flex-shrink: 0;')
[void]$html.AppendLine('    display: flex; align-items: center; justify-content: center;')
[void]$html.AppendLine('    box-shadow: 0 2px 8px rgba(0,0,0,0.15);')
[void]$html.AppendLine('    transition: background 0.3s, transform 0.2s;')
[void]$html.AppendLine('}')
[void]$html.AppendLine('.sidebar-toggle:hover { transform: scale(1.1); }')
[void]$html.AppendLine('.sidebar-fade {')
[void]$html.AppendLine('    position: sticky; bottom: 0; height: 32px; margin-top: -32px;')
...
[void]$html.AppendLine('<button class="sidebar-toggle" id="sidebarToggle" aria-label="Menu">☰</button>')
...
[void]$html.AppendLine('</div>')
[void]$html.AppendLine('<button class="theme-toggle" id="themeToggle" aria-label="Toggle theme">🌙</button>')
[void]$html.AppendLine('</div>')
[void]$html.AppendLine('')
...
[void]$html.AppendLine("const themes = { mocha: '🌙', latte: '☀️' };")
...
[void]$html.AppendLine('    toggle.textContent = themes[next];')
...
[void]$html.AppendLine('const sToggle = document.getElementById("sidebarToggle");')
[void]$html.AppendLine('')
[void]$html.AppendLine('sToggle.addEventListener("click", () => {')
[void]$html.AppendLine('    sidebar.classList.toggle("open");')
[void]$html.AppendLine('});')
[void]$html.AppendLine('')
[void]$html.AppendLine("sidebar.querySelectorAll('a').forEach(a => {")
[void]$html.AppendLine('    a.addEventListener("click", () => sidebar.classList.remove("open"));')
[void]$html.AppendLine('});')
[void]$html.AppendLine('')
[void]$html.AppendLine('// Close sidebar on outside click')
[void]$html.AppendLine('document.addEventListener("click", (e) => {')
[void]$html.AppendLine('    if (!sidebar.contains(e.target) && e.target !== sToggle) {')
[void]$html.AppendLine('        sidebar.classList.remove("open");')
[void]$html.AppendLine('    }')
[void]$html.AppendLine('});')
[void]$html.AppendLine('</script>')
[void]$html.AppendLine('</body>')
